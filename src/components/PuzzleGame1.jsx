...
const PuzzleGame1 = () => {
  ...
  useEffect(() => {
    let piecesArray = [];
    for (let i = 1; i <= 25; i++) {
      piecesArray.push(`./images2/${i}.jpg`);
    }
  ...
  const checkCompletion = (newBoard) => {
    const correctOrder = Array.from({ length: 25 }, (_, i) => `./images2/${i + 1}.jpg`);
    ...
    <div className="container">
      ...
      {isCompleted && (
        <div className="congratulations-message">
          ...
          <img src="https://media.tenor.com/DXL84KB6lscAAAAi/confetti-cute.gif" alt="confetti"/>
        </div>
      )}
    </div>
  );
